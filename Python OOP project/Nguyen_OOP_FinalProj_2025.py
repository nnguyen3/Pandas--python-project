...
class Seq:
    ...
    def print_record(self):
        """
        >>> s = Seq("NhiNguyenGene", "THANHNHI", "Vietnamese")
        >>> s.print_record()
        Vietnamese THANHNHI : NHINGUYENGENE
        """
...
#      appends these to self.kmers. Default kmer parameter=3.
    def make_kmers(self, k= 3): 
        """
        >>> s = Seq("NHINGUYEN", "NhiNguyenGene", "Vietnamese")
        >>> s.make_kmers(3)
        ['NHI', 'HIN', 'ING', 'NGU', 'GUY', 'UYE', 'YEN']
        """
        self.kmers= [] #empty list for kmer
    ...
    def fasta(self):
        """
        >>> d = DNA("NhiNguyenGene", "THANHNHI", "human", "nhi123")
        >>> print(d.fasta())
        >human THANHNHI
        NNNNGUNNNGNNN
...
class DNA (Seq):
    def __init__(self, sequence, gene, species,gene_id):
        """
        >>> d = DNA("NhiNguyenGene", "THANHNHI", "mouse", "nhi123")
        >>> d.gene
        'THANHNHI'
    ...
    def reverse_complement(self):
        """
        >>> d = DNA("THANHNHI", "NhiNguyenGene", "mouse", "g123")
    ...
    def six_frames(self):
        """
        >>> d = DNA("THANHNHI", "NhiNguyenGene", "Vietnamese", "ID_1234")
        >>> d.six_frames()
        ['TNANNNNN', 'NANNNNN', 'ANNNNN', 'NNNNNTNA', 'NNNNTNA', 'NNNTNA']
...
class RNA(DNA):
    ...
    def make_codons(self):
        """
        >>> r = RNA("AAUCAUAUU", "NhiNguyenGene", "Vietnamese", "ID_1234")
        >>> r.make_codons()
        ['AAU', 'CAU', 'AUU']
        """
